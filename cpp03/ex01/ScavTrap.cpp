...
{
	std::cout << "\33[30;34m" << "ScavTrap" << "\x1b[0m" <<  " default constructor called (" << this->_name << ")"<< std::endl;
	this->_hitpoints = 100;
	this->_energy = 50;
	this->_attack = 20;
	return;
...
{
	std::cout << "\33[30;34m" << "ScavTrap" << "\x1b[0m" << " destructor called (" << this->_name << ")" << std::endl;
	return;
}
