...
ClapTrap::ClapTrap(std::string name)
{
	...
	this->_energy = 10;
	this->_attack = 0;
	std::cout << "\33[30;36m" << "ClapTrap" << "\x1b[0m" << " default constructor called : " << this->_name << " created" << std::endl;
}
...
ClapTrap::~ClapTrap(void)
{
	std::cout << "\33[30;36m" << "ClapTrap" << "\x1b[0m" << " destructor called : " << this->_name << " deleted" << std::endl;
	return ;
}
