...
void Form::checkError(Bureaucrat const &bureaucrat) const
{
	if (this->_signe == 0)
		throw Form::NotSignedException();
	if (this->_gradeExec < bureaucrat.getGrade())
		throw Form::BureaucratNotAllowException();
}
...
const char *Form::BureaucratNotAllowException::what(void) const throw()
{
	return ("grade of bureaucrat is to low to execute this form");
}
